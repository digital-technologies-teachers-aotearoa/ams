...
Once your site is live, switch to [Feature reference](../reference/index.md) to look things up instead of working through this series again.
...
7. [Custom profile fields](profile-fields.md)
8. [Forum](forum.md)
9. [Events](events.md)
10. [Resources](resources.md)
11. [Inviting your team](inviting-your-team.md)
12. [Launch checklist](launch-checklist.md)
