...
1. In the CMS, click **Pages** in the left sidebar, click **Home**, then click **Actions**, then **Edit**.
    ...
    ![The home page's edit form, before any content has been added](../../images/website/setup/first-pages-01-home-edit-empty.png)
...
2. In the **Body** section, click the **+** button and choose **Title block**.
    ...
    ![A title added to the home page and saved as a draft](../../images/website/setup/first-pages-02-home-title.png)
...
3. Click the **+** button again, choose **Lead paragraph block**, and write a short tagline underneath your heading.
    ...
    ![A tagline added under the title and saved as a draft](../../images/website/setup/first-pages-03-home-tagline.png)
...
4. Click **Toggle preview** (top right) to see how your heading and tagline will look on your live site, before anyone else can see it.
    ...
    ![The preview panel showing the title and tagline as they will appear to visitors](../../images/website/setup/first-pages-04-home-preview.png)

5. Click the arrow next to **Save draft**, then click **Publish**, to make your home page's new content visible to visitors.

    ![The confirmation message after publishing the home page](../../images/website/setup/first-pages-05-home-published.png)

6. Go back to **Pages > Home**.
    Click **Add child page**, then click **Content page**.

    ![The page type chooser shown after clicking Add child page under Home](../../images/website/setup/first-pages-06-add-child-page.png)
...
7. Type **About** as the title.
    ...
    ![The new About page with its title and a paragraph filled in](../../images/website/setup/first-pages-07-about-content.png)

8. Click the arrow next to **Save draft**, then click **Publish**.

    ![The confirmation message after publishing the About page](../../images/website/setup/first-pages-08-about-published.png)
...
9. Create a **Contact** page the same way — but for its content, choose **Contact Form** instead of a paragraph, and enter your association's email address as the recipient.
    ...
    ![The new Contact page with a Contact Form block and its recipient email filled in](../../images/website/setup/first-pages-09-contact-form-block.png)
...
10. Click the arrow next to **Save draft**, then click **Publish**, then open your new Contact page on your live site to see the form visitors will use.
    ...
    ![The published Contact page on the live site, showing the contact form](../../images/website/setup/first-pages-10-contact-live.png)
...
See the [CMS admin guide's Reserved URL patterns](../reference/cms.md#reserved-url-patterns) for the main ones — you'll only hit this if you try to create one of those pages, and the CMS tells you clearly if you do.
