...
See [Tutorial 7: Forum](../setup/forum.md) for a walkthrough of what this looks like from a client's side, including the "you must have an active membership" message a member without one sees.
