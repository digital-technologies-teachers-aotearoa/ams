...
**Who this page is for:** client decision-makers filling in the decision questionnaire, and anyone who wants to know what a setting actually changes on the website.
...
The provider sets these for you, based on your answers to the decision questionnaire (part of the onboarding intake pack).
...
| **Decided by** | the intake questionnaire's languages question |
...
|---|---|
| **Default** | `False` (off) |
| **Decided by** | the intake questionnaire's optional features question |
...
|---|---|
| **Default** | `True` (on) |
| **Decided by** | the intake questionnaire's staff notification preferences question |
...
| **Decided by** | the intake questionnaire's membership model question |
