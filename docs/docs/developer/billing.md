...
This page is the canonical, detailed reference for that flow — the [Xero billing setup guide](../hosting/xero-billing.md) and the [worked-example runbook](../hosting/provisioning-runbook.md#7-xero-connection) both link back here rather than duplicating it.
