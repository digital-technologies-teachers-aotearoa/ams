...
Turning it on ([`AMS_EVENTS_ENABLED`](../getting-started/settings-glossary.md#ams_events_enabled)) needs an environment change and a restart, so if you don't see **Events** in the Django admin yet, your provider hasn't switched it on — see the [events admin guide](../admin/events.md).
...
1. In the Django admin, click **Events**, then click **Add** next to **Locations**.
    ...
    ![The empty Add location form](../images/tutorials/events-01-location-form-empty.png)

2. Fill in a **Name** and **City**, then click **Save**.
    Everything else on this form is optional.

    ![The new location listed after saving](../images/tutorials/events-02-location-saved.png)
...
3. Click **Events**, then click **Add** next to **Events**.
    ...
    ![The empty Add event form](../images/tutorials/events-03-event-form-empty.png)
...
4. Fill in the fields below, add at least one session, then click **Save**.
    ...
    ![The new event listed after saving, not yet published](../images/tutorials/events-04-event-saved.png)
...
5. The event is hidden from the public until you mark it as published — the same way a CMS page stays a draft until you publish it.
    ...
    ![The event's Published checkbox, now checked](../images/tutorials/events-05-event-published.png)

6. Visit your events page to see it live.

    ![The event live on the public events page](../images/tutorials/events-06-event-live.png)
...
![The event's own page, showing its details and a Register to attend event button](../images/tutorials/events-07-event-detail.png)
...
See [Adding events to menus](../admin/events.md#adding-events-to-menus) — the short version is you link to `/events/` the same way you'd link to any other page, in [Tutorial 4: Navigation & menus](navigation-menus.md).
